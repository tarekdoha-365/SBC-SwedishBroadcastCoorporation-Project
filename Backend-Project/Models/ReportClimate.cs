...
namespace Backend_Project.Models
{
    class ReportClimate: Report
    {
        ...
        public ReportClimate(string Header, string Title, string Description, DateTime Published, bool Modified, bool IsExpired, string AuthorName)
        {
            _reportType = "Climate";
            _header = Header;
            _title = Title;
        ...
        public string ReportType { get => _reportType; }
